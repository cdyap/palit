				...
				<form action="/{{$company->slug}}/shipping" method="POST">
					...
					<div class="form-row">
						<div class="form-group col-xs-12">
							...
							<input type="text" name="email" class="form-control {{ $errors->has('email') ? 'has-error' : ''}}" required value="{{ old('email') }}">
						</div>
					</div>
					<div class="form-row">
						<div class="form-group col-xs-12 col-md-6">
							<label for="first_name">First name:*</label>
							<input type="text" name="first_name" class="form-control {{ $errors->has('first_name') ? 'has-error' : ''}}" required value="{{ old('first_name') }}">
						</div>
						<div class="form-group col-xs-12 col-md-6">
							<label for="last_name">Last name:*</label>
							<input type="text" name="last_name" class="form-control {{ $errors->has('last_name') ? 'has-error' : ''}}" required value="{{ old('last_name') }}">
						</div>
					</div>
					<div class="form-row">
						...
						<div class="form-group col-xs-7 col-sm-7">
							...
							<input type="number" name="contact_number" class="form-control {{ $errors->has('contact_number') ? 'has-error' : ''}}" required min="0" value="{{ old('contact_number') }}">
						</div>
					</div>
					...
					<div class="form-row">
						<div class="form-group col-xs-12">
							...
							<input type="text" name="shipping_address_1" class="form-control {{ $errors->has('shipping_address_1') ? 'has-error' : ''}}" required value="{{ old('shipping_address_1') }}">
						</div>
					</div>
					<div class="form-row">
						<div class="form-group col-xs-12">
					...
					<div class="form-row">
						<div class="form-group col-xs-8 col-sm-9">
							...
							<input type="text" name="city" class="form-control {{ $errors->has('city') ? 'has-error' : ''}}" required value="{{ old('city') }}">
						</div>
						<div class="form-group col-xs-4 col-sm-3">
							<label for="city">Zip code:*</label>
							<input type="text" name="zip_code" class="form-control {{ $errors->has('zip_code') ? 'has-error' : ''}}" required value="{{ old('zip_code') }}">
						</div>
					</div>
					<div class="form-row">
						...
						<div class="col-xs-12 col-md-12" style="padding-left: 0;">
							@foreach($payment_methods->where('is_available', true) as $payment_method)
								<label class="payment-method">
	                                <input type="radio" name="payment_method" value="{{$payment_method->id}}" class="payment-method-radio" required>
									<div class="block">							
                ...
                <table class="table">
                    ...
                    <tbody>
                        @foreach($cart->where('name', 'Product') as $item)
                            ...
                            @endforeach
                            <tr>
                                <td class="align-middle">{{$item->name}}<br><span class="text-grey">{{$description}}</span></td>
